...
class ValidateXlsx extends ValidateDocument implements ValidadeInterface
{
     ...
     * @var string
     */
    private $mimeTypeFile = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
