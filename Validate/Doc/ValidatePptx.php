...
class ValidatePptx extends ValidateDocument implements ValidadeInterface
{
     ...
     * @var string
     */
    private $mimeTypeFile = "application/vnd.openxmlformats-officedocument.presentationml.presentation";
